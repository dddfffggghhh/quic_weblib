...
const (
	CHECKFILESTATEURL = "https://192.168.1.198:6123/demo/checkFileState"
	CHECKINDEX = "https://192.168.1.198:6123/demo/checkIndex"
	INDEXUPLOAD = "https://192.168.1.198:6123/demo/indexUpload"
	FILESTATERECORD = "https://192.168.1.198:6123/demo/fileStateRecord"
	FILEUPLOADSUCCESS = "2"
	FILEUPLOADSECTION = "1"
	FILEUPLOADNONE = "0"
	SUCCESS = "success"
...
func main() {
	...
	udppath := flag.String("udppath","127.0.0.1:6121","upd  url  path")
	flag.Parse()
	urls := flag.Args()
	...
	uploadQuicRequest, err := uploadFileIntoWeblib(*uploadPath,"https://" + *udppath + "/uploadChunkResource", param)
	...
	if err != nil {
	  ...
	  _, err = quicClient.Do(uploadQuicRequest)
		if err != nil{
