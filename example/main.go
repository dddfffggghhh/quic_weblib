...
const (
	...
	ONE = "1"
	TWO = "2"
	FILEPATH = "/home/quicgo/mzhang/Downloads/"
...
func setupHandler(www string, trace bool) http.Handler {
	...
	mux.HandleFunc("/getPredictProtocol", func(writer http.ResponseWriter, request *http.Request) {
		...
		predictPath := "http://192.168.1.120:8088/getPredictProtocol?"+stringLossRate+"&"+stringAvagDelay+"&"+fileLength+"&"+networkBandwidth
	...
	mux.HandleFunc("/uploadChunkResource", func(writer http.ResponseWriter, request *http.Request) {
		...
		if contentRange != NULL {
			...
			fmt.Println("写入数据")
			writeTestResultIntoFile("/home/quicgo/mzhang/Downloads/testResult.txt",testResult)
		}
...
func main() {
	...
	//defaultZone := "http://211.66.87.36:7071/eureka/"
