...
const (
	CHECKFILESTATEURL = "https://127.0.0.1:6121/demo/checkFileState"
	CHECKINDEX = "https://127.0.0.1:6121/demo/checkIndex"
	INDEXUPLOAD = "https://127.0.0.1:6121/demo/indexUpload"
	FILESTATERECORD = "https://127.0.0.1:6121/demo/fileStateRecord"
	FILEUPLOADSUCCESS = "2"
	FILEUPLOADSECTION = "1"
	FILEUPLOADNONE = "0"
	SUCCESS = "success"
...
func main() {
	...
	uploadPath := flag.String("uploadPath","/home/quicgo/mzhang/uploadFile/10M.zip","upload real path")
	testResultPath := flag.String("testResultPath","/home/quicgo/mzhang/Downloads/testResult10M.txt","test result store path")
	path := flag.String("path","127.0.0.1:80","tcp url  path")
	token := flag.String("token","1","token  value")
	flag.Parse()
	urls := flag.Args()
	...
	uploadQuicRequest, err := uploadFileIntoWeblib(*uploadPath, "http://" + *path + ":9091/group/uploadResource.action", param)
	...
	uploadQuicRequest.Header.Add("Authorization","bearer "+string(*token))
	if err != nil {
	...
	if err != nil {
		...
		resp, err := tcpClient.Do(uploadQuicRequest)
		if err != nil{
